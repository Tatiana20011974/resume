...
public class AuthService {
    ...
    public ResponseEntity<String> sendTokenRequest(String username, String password) {
        ...
        // ИСПРАВЛЕНИЕ: Используйте LinkedMultiValueMap вместо HttpHeaders
      ...
      //  client_id=resumeID&client_secret=w9E3StaKRRxAKgeqqukYhCVyJEMC4KUA&grant_type=client_credentials&scope=openid profile email
